...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugOscilloscope Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugOscilloscope Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugOscilloscope Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugOscilloscope installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugOscilloscope Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugOscilloscope installer\n"
