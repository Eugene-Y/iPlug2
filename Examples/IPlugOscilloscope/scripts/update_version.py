...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugOscilloscope-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugOscilloscope-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugOscilloscope-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugOscilloscope-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugOscilloscope-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/IPlugOscilloscope.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugOscilloscope.iss",inplace=1):
